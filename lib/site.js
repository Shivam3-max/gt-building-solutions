...
export const PANCHKULA_MAPS_LINK = 'https://maps.app.goo.gl/jNos7RjGypuCLZ937';

// Google Tag Manager container ID (wraps GA4 + conversion event tracking).
// To activate: create a GTM container at tagmanager.google.com, then either
// set the NEXT_PUBLIC_GTM_ID env var before `npm run build`, or paste the
// literal 'GTM-XXXXXXX' id below, then rebuild. Configure a GA4 Configuration
// tag inside that GTM container to start collecting GA4 data — no separate
// gtag.js snippet is needed in this codebase.
